...
This Code of Conduct is our foundation for having a positive impact. It helps empower everyone engaging with any Mantoso project to understand their responsibilities.
...
This Code of Conduct applies to all repositories and communities for open source projects we're managing regardless of whether the repo explicitly calls out its use of this code. The code also applies in public spaces when an individual is representing a project or its community. Examples include using an official project e-mail address, posting via an official social media account, or acting as an appointed representative at an online or offline event. Representation of a project may be further defined and clarified by project maintainers.
